...
6. **coefficient_Pr_Qu_Ac_Din_Con** — результаты подсчета следующих коэффициентов:
  ...
  - коэффициента связности текста (Con) `cohesion_coefficient(self)` – отношение суммы предлогов и союзов к числу предложений. Этот коэффициент оценивает, насколько текст логически структурирован и как хорошо связаны между собой отдельные части текста, предложения и абзацы.
